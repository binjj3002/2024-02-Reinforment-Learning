...
def train_ddpg():
    ...
    for episode in range(num_episodes):
        ...
        # Thêm điều kiện dừng sớm nếu đủ điều kiện vật lý (ví dụ, con lắc đã ổn định)
        if total_reward >= 200:  # Một ngưỡng phần thưởng có thể thay đổi
            print(f"Episode {episode}: Con lắc ổn định")
            break
